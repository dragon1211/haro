        <div class="mailingList__messeage">
            配信エラーが発生したユーザーに対して各種対応を行うことができます。
        </div>
        ...
        <div class="section">
            ...
            <div class="section__body">
                ...
                <div id="contents_file_01" style="{$display_file_01}">
                    <p>
                    配信エラーが頻発するユーザーを自動的に削除するように設定できます。
                    </p>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br />[通知する]に設定した場合は、システム・エラーメール受信用メールアドレスに自動削除の実行内容を通知します。
                                    <br />※システム・エラーメール受信用メールアドレスは環境設定にて設定する事ができます。
                                </td>
                            </tr>
                        </table>
                ...
                <div id="contents_file_02" style="{$display_file_02}">
                    ...
                    <form name="member_reg" method="post" action="./?page=ErrMailList">
                        ...
                        <div id="command" class="clearfix">
                            <div class="button_box" style="width:370px;float:left;text-align:left">
                            ...
                            <div class="button_box" style="width:400px;float:right;text-align:right">
                ...
                <div id="contents_file_03" style="{$display_file_03}">
                    ...
                    <form name="member_delete" method="post" action="./?page=ErrMailList">
                        ...
                        <div id="command">
                            <div class="button_box" style="width:600px;float:left;text-align:left">
                                <input type="button" value="全選択" id="all_check">
                                <input type="button" value="全解除" id="all_uncheck">
                                <input type="submit" name="sb_Address_delete" value="選択したアドレスをユーザーから削除する"
