        ...
        <div id="search_section" class="section">
            <h3 class="section__ttl">空メール自動登録用メールアドレス</h3>
        ...
        <div class="section">
            <h3 class="section__ttl">登録用フォーム</h3>
            <div class="section__body">
                <p>
                    登録用フォームを表示する設置タグです。<br>下記の設置タグをWebページに貼り付けることで、登録用フォームを設置できます。
                </p>
                <p class="mb5"><strong>サンプル</strong></p>
                <div class="border border--gray mb20">
                    <p class="ml20"><input type="text" /><input type="button" value="登録する" /></p>
                </div>
...
&lt;/form&gt;</textarea>
        ...
        <div class="section">
            <h3 class="section__ttl">登録・退会用フォーム</h3>
            <div class="section__body">
                <p>
                    登録・退会用フォームを表示する設置タグです。<br>
                ...
                <div class="border border--gray mb20">
                    <p class="ml20">
                        ...
                        <input type="text" /><input type="button" value="退会する" />
                    </p>
                </div>
